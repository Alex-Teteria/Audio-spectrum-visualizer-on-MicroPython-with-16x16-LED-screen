...
adc = ADC(26)  # вхід АЦП - pin 26
button_stop = Pin(5, Pin.IN, Pin.PULL_UP) # button виходу з програми, використовується за необхідності
# визначення різних кольорів led-матриці:
green = 0, 32, 0
